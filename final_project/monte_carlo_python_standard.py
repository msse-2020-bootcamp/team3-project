...
new_coordinates = run_simulation(coordinates, box_length, cutoff, reduced_temperature, num_steps, max_displacement, freq)
time_end = time.time()
time_due = time_end - time_start
print('time cost of '+str(num_steps)+ ' steps :' +str(time_due) + 's')